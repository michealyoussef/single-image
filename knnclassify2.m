function classes = knnclassify(sample, TRAIN, group, K, distance,rule)
%KNNCLASSIFY classifies data using the nearest-neighbor method
%
%   NOTE: KNNCLASSIFY will be removed in a future release. Use fitcknn to
%   fit a KNN classification model and classify data using
...
%
%   See also  CLASSPERF, CROSSVALIND, FITCKNN, FITCSVM, KNNIMPUTE.
